...
const columns = [
  ...
  {
    "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
    "SchemaName": "cr3ea_noofpackschecked",
    "DisplayName": {
      "LocalizedLabels": [{ "Label": "No of Packs Checked", "LanguageCode": 1033 }]
    },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 50
  },
  {
    "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
    "SchemaName": "cr3ea_pressureheld",
    "DisplayName": {
      "LocalizedLabels": [{ "Label": "Pressure Held", "LanguageCode": 1033 }]
    },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 50
  },
  {
    "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
    "SchemaName": "cr3ea_holdingtime",
    "DisplayName": {
      "LocalizedLabels": [{ "Label": "Holding Time", "LanguageCode": 1033 }]
    },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 50
  },
  {
    "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
    "SchemaName": "cr3ea_noofleakage",
    "DisplayName": {
      "LocalizedLabels": [{ "Label": "No of Leakage", "LanguageCode": 1033 }]
    },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 50
  },
  {
    ...
    "DisplayName": {
      "LocalizedLabels": [{ "Label": "Leakage Type", "LanguageCode": 1033 }]
    },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 100
  },
...
// Set to cr3ea_rajpura_pkgops_sealintegrity for UAT, or cr3ea_prod_rajpura_pkgops_sealintegrity for PROD/DEV
const tableLogicalName = "cr3ea_rajpura_pkgops_sealintegrity";
...
async function createColumns() {
  ...
  console.log("==========================================");
  console.log("Dataverse Column Creation: 10_PKGOPS_SEAL_INTEGRITY");
  console.log("==========================================");
  ...
  console.log("------------------------------------------");
  console.log("Finished 10_PKGOPS_SEAL_INTEGRITY.");
  console.log("==========================================");
}
