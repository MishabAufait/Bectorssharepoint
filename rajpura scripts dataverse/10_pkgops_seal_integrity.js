...
const columns = [
  ...
  {
    "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
    "SchemaName": "cr3ea_machineno",
    "DisplayName": { "LocalizedLabels": [{ "Label": "Machine No", "LanguageCode": 1033 }] },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 50
  },
  {
    "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
    "SchemaName": "cr3ea_samplequantity",
    "DisplayName": { "LocalizedLabels": [{ "Label": "Sample Quantity", "LanguageCode": 1033 }] },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 50
  },
  {
    ...
    "DisplayName": { "LocalizedLabels": [{ "Label": "No of Leakage", "LanguageCode": 1033 }] },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 50
  },
  {
...
async function createColumns() {
  ...
  console.log("==========================================");
  console.log("Dataverse Column Sync: 10_PKGOPS_SEAL_INTEGRITY (NON-PROD)");
  console.log("==========================================");
