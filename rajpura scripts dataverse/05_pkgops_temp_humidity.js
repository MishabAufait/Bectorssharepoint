...
const columns = [
  ...
  {
    "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
    "SchemaName": "cr3ea_ambienttemp",
    "DisplayName": {
      "LocalizedLabels": [{ "Label": "Ambient Temp", "LanguageCode": 1033 }]
    },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 50
  },
  {
    "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
    "SchemaName": "cr3ea_ambienthumidity",
    "DisplayName": {
      "LocalizedLabels": [{ "Label": "Ambient Humidity", "LanguageCode": 1033 }]
    },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 50
  },
  {
    "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
    "SchemaName": "cr3ea_doughroomtemp",
    "DisplayName": {
      "LocalizedLabels": [{ "Label": "Dough Room Temp", "LanguageCode": 1033 }]
    },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 50
  },
  {
    "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
    "SchemaName": "cr3ea_doughroomhumidity",
    "DisplayName": {
      "LocalizedLabels": [{ "Label": "Dough Room Humidity", "LanguageCode": 1033 }]
    },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 50
  },
  {
    "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
    "SchemaName": "cr3ea_coldroom1temp",
    "DisplayName": {
      "LocalizedLabels": [{ "Label": "Cold Room 1 Temp", "LanguageCode": 1033 }]
    },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 50
  },
  {
    "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
    "SchemaName": "cr3ea_coldroom2temp",
    "DisplayName": {
      "LocalizedLabels": [{ "Label": "Cold Room 2 Temp", "LanguageCode": 1033 }]
    },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 50
  },
  {
    ...
    "DisplayName": {
      "LocalizedLabels": [{ "Label": "Cold Room 1 Observed Temp", "LanguageCode": 1033 }]
    },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 50
  },
  {
    ...
    "DisplayName": {
      "LocalizedLabels": [{ "Label": "Cold Room 2 Observed Temp", "LanguageCode": 1033 }]
    },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 50
  },
  {
    ...
    "DisplayName": {
      "LocalizedLabels": [{ "Label": "Cold Room 3 Observed Temp", "LanguageCode": 1033 }]
    },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 50
  },
  {
    ...
    "DisplayName": {
      "LocalizedLabels": [{ "Label": "Deep Freezer Yeast Temp", "LanguageCode": 1033 }]
    },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 50
  }
...
// Set to cr3ea_rajpura_pkgops_temphumidity for UAT, or cr3ea_prod_rajpura_pkgops_temphumidity for PROD/DEV
...
async function createColumns() {
  ...
  console.log("==========================================");
  console.log("Dataverse Column Creation: 05_PKGOPS_TEMP_HUMIDITY");
  console.log("==========================================");
