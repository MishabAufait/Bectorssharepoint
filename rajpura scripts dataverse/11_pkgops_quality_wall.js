...
// Set to cr3ea_rajpura_pkgops_qualitywall for UAT, or cr3ea_prod_rajpura_pkgops_qualitywall for PROD/DEV
...
async function createColumns() {
  ...
  console.log("==========================================");
  console.log("Dataverse Column Creation: 11_PKGOPS_QUALITY_WALL");
  console.log("==========================================");
