...
const columns = [
  ...
  {
    "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
    "SchemaName": "cr3ea_product",
    "DisplayName": {
      "LocalizedLabels": [{ "Label": "Product", "LanguageCode": 1033 }]
    },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 150
  },
  ...
  {
    "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
    "SchemaName": "cr3ea_codepictureurl",
    "DisplayName": {
      "LocalizedLabels": [{ "Label": "Code Picture URL", "LanguageCode": 1033 }]
    },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 500
  },
  ...
  },
  {
    ...
    "DisplayName": {
      "LocalizedLabels": [{ "Label": "PKD", "LanguageCode": 1033 }]
    },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 100
  },
  {
    "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
    "SchemaName": "cr3ea_expirydate",
    "DisplayName": {
      "LocalizedLabels": [{ "Label": "Expiry Date", "LanguageCode": 1033 }]
    },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 100
  },
  {
    "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
    "SchemaName": "cr3ea_usebydate",
    "DisplayName": {
      "LocalizedLabels": [{ "Label": "Use By Date", "LanguageCode": 1033 }]
    },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 100
  },
  ...
  {
    "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
    "SchemaName": "cr3ea_mrp",
    "DisplayName": {
      "LocalizedLabels": [{ "Label": "MRP", "LanguageCode": 1033 }]
    },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 50
  },
  {
    "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
    "SchemaName": "cr3ea_usp",
    "DisplayName": {
      "LocalizedLabels": [{ "Label": "USP", "LanguageCode": 1033 }]
    },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 50
  }
...
// Set to cr3ea_rajpura_pkgops_codeverification for UAT, or cr3ea_prod_rajpura_pkgops_codeverification for PROD/DEV
const tableLogicalName = "cr3ea_rajpura_pkgops_codeverification";
...
async function createColumns() {
  ...
  console.log("==========================================");
  console.log("Dataverse Column Creation: 06_PKGOPS_CODE_VERIFICATION");
  console.log("==========================================");
  ...
  console.log("------------------------------------------");
  console.log("Finished 06_PKGOPS_CODE_VERIFICATION.");
  console.log("==========================================");
}
