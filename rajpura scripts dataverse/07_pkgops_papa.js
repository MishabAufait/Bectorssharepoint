...
const tableLogicalName = "cr3ea_rajpura_pkgops_papa";
...
const columns = [
  ...
  {
    "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
    "SchemaName": "cr3ea_noofsamples",
    "DisplayName": { "LocalizedLabels": [{ "Label": "No of Samples", "LanguageCode": 1033 }] },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 50
  },
  {
    "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
    "SchemaName": "cr3ea_defecttype",
    "DisplayName": { "LocalizedLabels": [{ "Label": "Defect Type", "LanguageCode": 1033 }] },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 250
  },
  {
    ...
    "DisplayName": { "LocalizedLabels": [{ "Label": "Defect Count", "LanguageCode": 1033 }] },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 50
  },
  {
    "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
    "SchemaName": "cr3ea_defectwisepercentage",
    "DisplayName": { "LocalizedLabels": [{ "Label": "Defectwise Percentage", "LanguageCode": 1033 }] },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 50
  },
  {
    "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
    "SchemaName": "cr3ea_overalldefectpercentage",
    "DisplayName": { "LocalizedLabels": [{ "Label": "Overall Defect Percentage", "LanguageCode": 1033 }] },
    "RequiredLevel": { "Value": "None" },
    "MaxLength": 50
  },
  {
...
async function createColumns() {
  ...
  console.log("==========================================");
  console.log("Dataverse Column Sync: 07_PKGOPS_PAPA (NON-PROD)");
  console.log("==========================================");
  ...
  console.log("------------------------------------------");
  console.log("Finished 07_PKGOPS_PAPA.");
  console.log("==========================================");
}
